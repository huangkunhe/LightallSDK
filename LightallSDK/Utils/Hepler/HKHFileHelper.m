...
#import "HKHFileHelper.h"

@implementation HKHFileHelper
...
+(NSString *)groupPath:(NSString *)fileName
{
    NSString *appGroupId = [UserDefaults objectForKey:kNumVersionDataGroupC] ?[UserDefaults objectForKey:kNumVersionDataGroupC] :  @"group.com.richinfo.callassistant";
//    NSString *appGroupId = @"group.com.richinfo.callassistant";
    
    NSURL *appGroupDirectoryPath = [[NSFileManager defaultManager] containerURLForSecurityApplicationGroupIdentifier:appGroupId];
    
    NSURL *dataBaseURL = [appGroupDirectoryPath  URLByAppendingPathComponent:fileName];
