...
@implementation TD_ER3DESEncrypt
...
- (NSString *)encryptString:(NSString *)originalString
{
    ...
    NSString *string = [TD_GTMBase64 stringByEncodingData:[NSData dataWithBytes:(const void *)bufferPtr length:(NSUInteger)movedBytes]];
    free(bufferPtr);
    return string;
}
...
{
    NSData *encryptedStringData = [TD_GTMBase64 decodeData:[encryptedString dataUsingEncoding:NSUTF8StringEncoding]];
